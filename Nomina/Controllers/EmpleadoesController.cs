...
namespace Nomina.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpleadoID,NombreEmpleado,DepartamentoID,Estatus,Sueldo")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpleadoID,NombreEmpleado,DepartamentoID,Estatus,Sueldo")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
